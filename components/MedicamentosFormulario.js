...
const MedicamentosFormulario = () => {
    ...
    <form class="row g-3">
        ...
        <div class="col col-md-12">
            <label for="fecha" class="form-label">Fecha de formulación:</label>
            <input type="date" class="form-control" id="fecha">
        </div>
        <div class="col-md-10">
        <label for="validationServer01" class="form-label">Nombre Medicamento (Forma farmacéutica)</label>
        <input type="text" class="form-control" value="" required>
        <div class="valid-feedback">      
        </div>
        <div class="col-md-6">
        <label for="validationServer01" class="form-label">Concentración</label>
        <input type="text" class="form-control" value="" required>
        <div class="valid-feedback">      
        </div>    
        <div class="col-md-6">
        <label for="validationServer01" class="form-label">Dosificación</label>
        <input type="text" class="form-control" value="" required>
        <div class="valid-feedback">      
        </div>
        <div class="col-md-6">
        <label for="validationServer01" class="form-label">Frecuencia (hr)</label>
        <input type="text" class="form-control" value="" required>
        <div class="valid-feedback">      
        </div> 
        <div class="col-md-6">
        <label for="validationServer01" class="form-label">Cantidad Total</label>
        <input type="text" class="form-control" value="" required>
        <div class="valid-feedback">      
        </div> 
        <div class="col-12">
        ...
        <button type="submit" class="btn btn-primary mt-3">Formular</button> 
        </div> 
    </form>
    `
